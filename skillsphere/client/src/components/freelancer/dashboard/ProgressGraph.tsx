...
// import { TrendingUp, Target, Award, Clock, Star } from 'lucide-react';
...
// //     const earningsPct = Math.min((data.earningsProgress.current / data.earningsProgress.goal) * 100, 100);
...
// //   const earningsChartData = data.earningsProgress.monthly.map(m => ({
// //     month: m.month,
// //     actual: m.amount,
...
//   onPeriodChange
// }) => {
//   const [data, setData] = useState<ProgressData | null>(null);  // State to store the fetched data
...
//       try {
//         const result = await API.get('/freelancer/progress');  // Use API service
//         setData(result.data);  // Set the fetched data to the state
//       } catch (error) {
//         console.log('Error in fetching progress data:', error);
//         toast.error('Failed to load progress data');  // Show error toast
...
//   // Handle loading, error, and rendering the chart
//   if (loading) {
...
//   if (!data) {
//     return <div>No data available</div>;  // In case the data is still not set
//   }
